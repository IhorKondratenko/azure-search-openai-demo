...
AZURE_STORAGE_ACCOUNT = os.environ.get(
    "AZURE_STORAGE_ACCOUNT") or "stoi5kewn7ad47y"
AZURE_STORAGE_CONTAINER = os.environ.get(
    "AZURE_STORAGE_CONTAINER") or "content"
AZURE_SEARCH_SERVICE = os.environ.get(
    "AZURE_SEARCH_SERVICE") or "gptkb-oi5kewn7ad47y"
...
openai.api_key = "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"
